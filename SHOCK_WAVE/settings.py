...
MIDDLEWARE = [
    ...
    # the above line includes to show the time in admin panel in admin local time zone.
...
CSRF_TRUSTED_ORIGINS = ['https://shockwave.zaicrm.com', 'https://shockalert.eastus.cloudapp.azure.com']
...
GOOGLE_PACKAGE_NAME = str(os.getenv('GOOGLE_PACKAGE_NAME'))
